...
namespace App.UI {
    ...
    public class Indicator : MonoBehaviour {
        ...
        public void Initialize(int count, Color C, string description = "", bool perfect = false, float delay = 0) {
            countText.color = C;
            ...
            StartCoroutine(RiseAndFade(C,delay));
        ...
        private IEnumerator RiseAndFade(Color c,float delay = 0) {
            ...
            while(timer > 0) {
                ...
                countText.color = descriptionText.color = new Color(c.r, c.g, c.b, p);
